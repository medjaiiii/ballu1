...
module.exports = function (grunt) {
    ...
    if (process.argv[2] == 'rename') {
        ...
        if (!newname) {
            console.log('Please write the new haier name, like: "grunt rename --name=mywidgetset" --author="Author Name"');
            process.exit();
        }
        ...
        if (fs.existsSync(__dirname + '/admin/haier.png')) {
            fs.renameSync(__dirname + '/admin/haier.png',              __dirname + '/admin/' + newname + '.png');
        }
        if (fs.existsSync(__dirname + '/widgets/haier.html')) {
            fs.renameSync(__dirname + '/widgets/haier.html',           __dirname + '/widgets/' + newname + '.html');
        }
        if (fs.existsSync(__dirname + '/widgets/haier/js/haier.js')) {
            fs.renameSync(__dirname + '/widgets/haier/js/haier.js', __dirname + '/widgets/haier/js/' + newname + '.js');
        }
        if (fs.existsSync(__dirname + '/widgets/haier')) {
            fs.renameSync(__dirname + '/widgets/haier',                __dirname + '/widgets/' + newname);
        }
    }
            ...
            name: {
                options: {
                    patterns: [
                        ...
                        {
                            match: /Haier/g,
                            replacement: newname ? (newname[0].toUpperCase() + newname.substring(1)) : 'Haier'
                        },
                        {
                            match: /instalator/g,
                            replacement: author
